...
// ======================================
//  External Link for Certification Icon
// ======================================
document.addEventListener('DOMContentLoaded', function() {
    const gdriveIcon = document.getElementById('gdrive-link-icon');

    if (gdriveIcon) {
        gdriveIcon.addEventListener('click', function(event) {
            // This is CRITICAL: It stops the main button's filter action from firing
            event.stopPropagation(); 
            
            // TODO: Replace with your actual Google Drive link
            const googleDriveUrl = "https://drive.google.com/drive/folders/1qLaayHLjXO2cwBIFcoMscQI47v2eVxFC?usp=drive_link";
            
            // Opens your Google Drive link in a new tab
...
$(document).on('DOMContentLoaded', function () {
    window.ityped.init(document.querySelector('.ityped'), {
        strings: ['HI THERE!', 'I’M PRAJWAL SHARMA', 'Backend Developer!'],
        loop: true
    });
});
...
/*------------------------------------- Tabs -------------------------------------*/
/*------------------------------------- Tabs (Corrected Version) -------------------------------------*/
$(function () {
    $(document).on('click', '.tab-btn-main a.tab-btn', function (e) {
        e.preventDefault();
        
        // Get the ID of the content to show
        const tabId = $(this).data('tab');
        
        // Find the closest parent section to scope our changes
        const parentSection = $(this).closest('section');
        
        // Deactivate all buttons and content *within this section only*
        parentSection.find('.tab-btn').removeClass('tab-active');
        parentSection.find('.Tabcondent').removeClass('tab-active');
        
        // Activate the clicked button
        $(this).addClass('tab-active');
        
        // Activate the corresponding content pane by its ID
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Attach the submission handler to the form, but only if the form exists
    if (form) {
        // Set your Formspree URL here
        form.action = "https://formspree.io/f/mdkddvnl"; 
        form.method = "POST";
